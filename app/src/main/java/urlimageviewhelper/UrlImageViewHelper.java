...
public final class UrlImageViewHelper {
    static void clog(@NotNull String format, @NotNull Object... args) {
        String log;
        if (args.length == 0)
            log = format;
        else
    ...
    public static int copyStream(@NotNull final InputStream input, @NotNull final OutputStream output) throws IOException {
        @NotNull final byte[] stuff = new byte[8192];
        int read;
        int total = 0;
    ...
    private static void prepareResources(@NotNull final Context context) {
        if (mMetrics != null) {
            return;
        }
    ...
    @Nullable
    private static Bitmap loadBitmapFromStream(@NotNull final Context context, final String url, @NotNull final String filename, final int targetWidth, final int targetHeight) {
...
//        Log.v(Constants.LOGTAG,targetHeight);
        ...
        try {
            @Nullable BitmapFactory.Options o = null;
     ...
     */
    public static void setUrlDrawable(@NotNull final ImageView imageView, @NotNull final String url, final int defaultResource) {
     ...
     * @param url The URL of the image that should be loaded.
     */
    public static void setUrlDrawable(@NotNull final ImageView imageView, @NotNull final String url) {
        setUrlDrawable(imageView.getContext(), imageView, url, null, CACHE_DURATION_THREE_DAYS, null);
    }

    public static void loadUrlDrawable(@NotNull final Context context, @NotNull final String url) {
     ...
     */
    public static void setUrlDrawable(@NotNull final ImageView imageView, @NotNull final String url, final Drawable defaultDrawable) {
     ...
     */
    public static void setUrlDrawable(@NotNull final ImageView imageView, @NotNull final String url, final int defaultResource, final long cacheDurationMs) {
        setUrlDrawable(imageView.getContext(), imageView, url, defaultResource, cacheDurationMs);
    }

    public static void loadUrlDrawable(@NotNull final Context context, @NotNull final String url, final long cacheDurationMs) {
     ...
     *            image should be cached locally.
     */
    public static void setUrlDrawable(@NotNull final ImageView imageView, @NotNull final String url, final Drawable defaultDrawable, final long cacheDurationMs) {
     ...
     *            image should be cached locally.
     */
    private static void setUrlDrawable(@NotNull final Context context, @NotNull final ImageView imageView, @NotNull final String url, final int defaultResource, final long cacheDurationMs) {
        @Nullable Drawable d = null;
     ...
     *            value can be null.
     */
    public static void setUrlDrawable(@NotNull final ImageView imageView, @NotNull final String url, final int defaultResource, final UrlImageViewCallback callback) {
     ...
     *            value can be null.
     */
    public static void setUrlDrawable(@NotNull final ImageView imageView, @NotNull final String url, final UrlImageViewCallback callback) {
        setUrlDrawable(imageView.getContext(), imageView, url, null, CACHE_DURATION_THREE_DAYS, callback);
    }

    public static void loadUrlDrawable(@NotNull final Context context, @NotNull final String url, final UrlImageViewCallback callback) {
     ...
     *            value can be null.
     */
    public static void setUrlDrawable(@NotNull final ImageView imageView, @NotNull final String url, final Drawable defaultDrawable, final UrlImageViewCallback callback) {
     ...
     *            value can be null.
     */
    public static void setUrlDrawable(@NotNull final ImageView imageView, @NotNull final String url, final int defaultResource, final long cacheDurationMs, final UrlImageViewCallback callback) {
        setUrlDrawable(imageView.getContext(), imageView, url, defaultResource, cacheDurationMs, callback);
    }

    public static void loadUrlDrawable(@NotNull final Context context, @NotNull final String url, final long cacheDurationMs, final UrlImageViewCallback callback) {
     ...
     *            value can be null.
     */
    public static void setUrlDrawable(@NotNull final ImageView imageView, @NotNull final String url, final Drawable defaultDrawable, final long cacheDurationMs, final UrlImageViewCallback callback) {
     ...
     *            value can be null.
     */
    private static void setUrlDrawable(@NotNull final Context context, @NotNull final ImageView imageView, @NotNull final String url, final int defaultResource, final long cacheDurationMs, final UrlImageViewCallback callback) {
        @Nullable Drawable d = null;
        if (defaultResource != 0) {
            d = imageView.getResources().getDrawable(defaultResource);
        }
    ...
    private static boolean isNullOrEmpty(@Nullable final CharSequence s) {
    ...
    @NotNull
    public static String getFilenameForUrl(@NotNull final String url) {
     ...
     *              will be removed.
     */
    public static void cleanup(@NotNull final Context context, long age) {
        if (mHasCleaned) {
            return;
        }
        mHasCleaned = true;
        try {
            ...
            for (@NotNull final String file : files) {
                if (!file.endsWith(".urlimage")) {
                    continue;
                }

                @NotNull final File f = new File(context.getFilesDir().getAbsolutePath() + '/' + file);
     ...
     * @param context
     */
    public static void cleanup(@NotNull final Context context) {
        cleanup(context, CACHE_DURATION_ONE_WEEK);
    }
    
    private static boolean checkCacheDuration(@NotNull File file, long cacheDurationMs) {
    ...
    public static Bitmap getCachedBitmap(@Nullable String url) {
        if (url == null)
            return null;
        @Nullable Bitmap ret = null;
        if (mDeadCache != null)
            ret = mDeadCache.get(url);
        if (ret != null)
            return ret;
        if (mLiveCache != null) {
            @Nullable Drawable drawable = mLiveCache.get(url);
     ...
     *            value can be null.
     */
    private static void setUrlDrawable(@NotNull final Context context, @Nullable final ImageView imageView, @NotNull final String url, final Drawable defaultDrawable, final long cacheDurationMs, @Nullable final UrlImageViewCallback callback) {
        ...
        @NotNull final String filename = context.getFileStreamPath(getFilenameForUrl(url)).getAbsolutePath();
        ...
        @Nullable Bitmap bitmap = mDeadCache.remove(url);
        if (bitmap != null) {
        ...
        @NotNull final ArrayList<ImageView> downloads = new ArrayList<ImageView>();
        if (imageView != null) {
        ...
        @NotNull final Loader loader = new Loader() {
            @Override
            public void onDownloadComplete(@Nullable UrlDownloader downloader, @Nullable InputStream in, @Nullable String existingFilename) {
                try {
                    assert (in == null || existingFilename == null);
                    if (in == null && existingFilename == null)
                        return;
                    @Nullable String targetFilename = filename;
                    if (in != null) {
                        in = new BufferedInputStream(in, 8192);
                        @NotNull OutputStream fout = new BufferedOutputStream(new FileOutputStream(filename), 8192);
                        copyStream(in, fout);
                        fout.close();
                    }
                    else {
        ...
        @NotNull final Runnable completion = new Runnable() {
            @Override
            public void run() {
                assert (Looper.myLooper().equals(Looper.getMainLooper()));
                @Nullable Bitmap bitmap = loader.result;
                @Nullable Drawable usableResult = null;
                if (bitmap != null) {
...
//                mLiveCache.put(url, usableResult);
                ...
                int waitingCount = 0;
                for (@NotNull final ImageView iv: downloads) {
...
//                        System.out.println(String.format("imageView: %dx%d, %dx%d", imageView.getMeasuredWidth(), imageView.getMeasuredHeight(), imageView.getWidth(), imageView.getHeight()));
        ...
        if (file.exists()) {
            try {
                if (checkCacheDuration(file, cacheDurationMs)) {
                    ...
                    @NotNull final AsyncTask<Void, Void, Void> fileloader = new AsyncTask<Void, Void, Void>() {
                        @Nullable
                        @Override
        ...
        for (@NotNull UrlDownloader downloader: mDownloaders) {
    ...
    private static int getHeapSize(@NotNull final Context context) {
     ...
     */
    @Nullable
    public static Bitmap remove(@NotNull String url) {
        new File(getFilenameForUrl(url)).delete();
        
        @Nullable Drawable drawable = mLiveCache.remove(url);
        if (drawable instanceof ZombieDrawable) {
            @NotNull ZombieDrawable zombie = (ZombieDrawable)drawable;
    ...
    static void executeTask(@NotNull final AsyncTask<Void, Void, Void> task) {
	...
	private static void executeTaskHoneycomb(@NotNull final AsyncTask<Void, Void, Void> task) {
