...
public class CoursesActivity extends BaseActivity implements OnItemClickListener{
...
protected void onCreate(Bundle savedInstanceState) {
	...
	context=(Activity)CoursesActivity.this;
...
private void intiViews() {
    mHeaderText= (TextView) findViewById(R.id.txt_coursesListHeader);
    mHeaderText.setText(getResources().getString(R.string.lbl_courses));
...
@NotNull Intent i= new Intent(CoursesActivity.this, CourseDetailsActivity.class);

	//Intent i= new Intent(CoursesActivity.this, SchiduleActivity.class);
